		...
		function createGraph(type)
		{
			...
			switch (type) {
				...
				case "interruption": 
					...
					graphDiv = $("<div style='display:none;color:black;' class='wrapper' id='wrapper-"+type+"'><h5 class='graph-header'><span>Speech Overlap</span></h5><div id='"+type+"' class='graph-container'><object data='graphs/public/svg/overlaps.svg' type='image/svg+xml' style='margin-left:30%;'><img src='graphs/public/svg/overlaps.svg' /></object></div></div>");					
					break;
				case "attitude":
