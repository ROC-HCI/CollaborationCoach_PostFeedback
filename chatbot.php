		...
		function createGraph(type)
		{
			...
			switch (type) {
				...
				case "interruption": 
					...
					graphDiv = $("<div style='display:none;color:black;' class='wrapper' id='wrapper-"+type+"'><h5 class='graph-header'><span>Speech Overlap</span></h5><div id='"+type+"' class='graph-container'><object data='graphs/public/svg/overlaps.svg' type='image/svg+xml' style='margin:25%;'><img src='overlap.png' /></object></div></div>");
					break;
				case "attitude":
