	...
	<script>
		...
		function createGraph(type)
		{
			...
			switch (type) {
				...
				//needs fixing
				case "interruption": 
					graphDiv = $("<div style='display:none;color:black;' class='wrapper' id='wrapper-"+type+"'><h5><span>Speech Overlap</span></h5><div id='"+type+"' class='graph-container'><object data='graphs/public/svg/overlaps.svg' type='image/svg+xml'><img src='overlap.png' /></object><div class='outer'><p><span class='chart-label' id='chart1'></span></p><p>By You</p></div><div class='outer'><p><span class='chart-label' id='chart2'></span></p><p>By Others</p></div></div></div>");
					break;
				case "attitude":
