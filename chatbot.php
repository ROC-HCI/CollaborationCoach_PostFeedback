		...
		function createGraph(type)
		{
			...
			switch (type) {
				...
				case "interruption": 
					...
					break;
				case "attitude":
					graphDiv = $("<div style='display:none;' class='wrapper' id='wrapper-"+type+"'><h5 class='graph-header'><span>Attitude Towards</span></h5><div id='"+type+"' class='graph-container'><div align='center'><canvas style='width:430px;height:220px' id='barChart' width='455' height='250'></canvas></div></div></div>");
					break;
