		...
		function createGraph(type)
		{
			...
			switch (type) {
				...
				case "interruption":
					...
					break;
				case "turntaking":
					graphDiv = $("<h3>"+type+"</h3><div style='display:none;' id='"+type+"' class='graph-container'><div id='chart4' data-value='0' data-user=''></div><div class='container-background'></div></div>");
					break;
